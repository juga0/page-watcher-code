...
from policies_scraper.items import PoliciesScraperItem
from policies_scraper.util import save_html, append, now_timestamp, \
    url2filename
...
class PoliciesSpider(scrapy.Spider):
    ...
    def __init__(self, policies_path="", url="", xpath="",  *args, **kwargs):
        super(PoliciesSpider, self).__init__(*args, **kwargs)
